...
rds = function(
 ...
 if (true && _d___ != undefined && _d___ != null) {
     ...
     var _b_ = element[['teams','project','instances','dblst','objects'][_l___]]
            // map()
            window.___G_.scenesigObj.add(window.___G_.circles(element/*[_k___]*/['_n_'],
...
pst = function(
 ...
 if (true && _d___ != undefined && _d___ != null) {
     ...
     var _b_ = _v_[['teams','project','instances','dblst','objects'][_l___]]
            ...
            _v_/*[_k___]*/['_y_'] = _d___[_k___].length == 1 ? 200 : (200 + 100) - 100 // 0 : Math.cos(Math.PI / _d___[_k___].length * 2 * _i_) * _r_ + 0
            }
            ...
            _b_[_j_]/*[_k___]*/['_y_'] = _v_/*[_k___]*/['_y_'] - 100 // Math.cos(_t_ * _j_) * _v_/*[_k___]*/['_p_'] + _v_/*[_k___]*/['_y_']
            }
            // }
            } else {
            // 
